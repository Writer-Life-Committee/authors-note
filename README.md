...
#### 笠井康平について
1988年生まれ。東京都在住。会社員。著書に『私的なものへの配慮No.3』（いぬのせなか座）。近著に「文化芸術の経済統計枠組みはいかにしてテキスト品質評価指標体系の開発計画に役立つのか」「文化と経済をめぐるブックリスト」「現代短歌のテキストマイニング――𠮷田恭大『光と私語』（いぬのせなか座）を題材に」。好きな

#### 小澤みゆきについて
1988年生まれ。東京都在住。会社員。編著に『かわいいウルフ』（亜紀書房）。近著に「ウルフ・チャット」「文芸という海――メジャーとインディペンデントの波間で」（「群像」掲載）、「若さの予感」（「しししし」掲載）。好きなおでんの具は「たまご」。
...
- ショートピッチの登壇者は購読者から募ります。謝金は出ません。

#### 追加報酬について
- 売上絶好調の場合、収支を清算したあとで、追加報酬を支払えるかもしれません（払えないかもしれません）。
- 目下の試算では、購読者が400名を超えると
