...
### 分量
- 4,000字を上限とします。
- 原稿料の算定には、派生相当字数1,000字を含みます。リテイク、著者略歴、広報協力など、完成稿に含まれないメタテキスト、パラテキストの執筆に係る対価です。

### 請求・支払
- 報酬は2021年8月中に支払います。同年7月中に請求書を発行してください。

### 原稿料とは何か
- その原稿が完成するまでに生じる一連の作業に対する対価をいいます。
- たとえば、以下が含まれると考えます。
...
- 執筆者には、業務委託契約書のオンライン締結リクエストを送ります。締結完了後に、着手金（後述）を支払います。
