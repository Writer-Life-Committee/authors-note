...
本サイトには、「作家の手帖」プロジェクトの成果物（※最終稿をのぞく）が掲載されていきます。Github Pagesという仕組みを用いて、Githubに掲載した原稿がそのまま記事になります。
...
をお読みいただいた上で、本プロジェクトに執筆、登壇、制作で参加を希望なさる方は、[Googleフォーム](https://docs.google.com/forms/d/e/1FAIpQLSddK7-cYI9zzO6wMjTwGqHf9dcVSErruk5bslFF4HAC5QGtbA/viewform)から応募をお願いします。体験談の投稿もあわせて受け付けます。

# 購読希望の方へ
[STORES](https://authors-note.stores.jp/)では、最終稿の入手と勉強会の視聴（アーカイヴを含む）ができる参加チケットを販売しています。購入すると、参加者コミュニティ（Discord）に参加でき、オンライン勉強会も視聴できます（3,000円）。また、8月に実施予定の勉強会でのショートスピーチ付きのチケットもあります（4,000円）。
