...
## 特徴
**本企画はウェブで展開する同人誌で、広い意味での「原稿料」を主題に、出版活動の流れ自体を目次とする構成です。**執筆者・制作スタッフを公募し、先に契約を結んでから、最終稿以外のテキストを[Github](https://github.com/Writer-Life-Committee/authors-note)で公表することで、**どの原稿がどのように執筆・編集・校正されたのかをみんなで共有できるようにする試みです。**
